    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-column">
          ...
          <a
            href="https://www.google.com/maps?q=Rivadavia+3098+(esquina+Suipacha),+Santa+Fe"
            target="_blank"
            rel="noopener noreferrer"
            className="address-link"
          >
            Rivadavia 3098 (esquina Suipacha), Santa Fe
          </a>
        </div>
        ...
        <div className="footer-column">
          ...
          <p className="contact-info">
            ...
            <a href="mailto:contacto@farmaciawagner.com.ar">contacto@farmaciawagner.com.ar</a>
          </p>
          <p className="contact-info">
            <svg fill="currentColor" viewBox="currentColor" fill="currentColor">
        ...
        <div className="footer-column">
          ...
          <div className="social-icons">
            <a href="https://www.instagram.com/farmacia_curvaroces/?hl=es" target="_blank" rel="noopener noreferrer">
              <svg fill="currentColor" viewBox="currentColor" fill="currentColor">
            ...
            <a href="https://www.facebook.com/curva.roces/" target="_blank" rel="noopener noreferrer">
              <svg fill="currentColor" viewBox="currentColor" fill="currentColor">
      ...
      <div className="footer-bottom">
        <div>
          <div className="payment-methods">
            ...
            <img src="/naranja.png" alt="Naranja" />
            <img src="/cabal.png" alt="Cabal" />
            <img src="/mercado-pago.png" alt="Mercado Pago" />
          </div>
          <div className="shipping-methods">
            <p>Medios de envío</p>
            <img src="/correo-argentino.png" alt="Correo Argentino" />
          </div>
          <div className="footer-links">
            <p>Copyright Farmacia Curva Roces - 2025. Todos los derechos reservados.</p>
          </div>
        </div>
